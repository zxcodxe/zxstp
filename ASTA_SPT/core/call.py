...
import config
from ASTA_SPT import LOGGER, YouTube, app
...
from ASTA_SPT.utils.formatters import check_duration, seconds_to_min, speed_converter
from ASTA_SPT.utils.inline.play import stream_markup
...
class Call(PyTgCalls):
    ...
    async def change_stream(
        ...
        # Queue empty hone par safely VC leave.
        if not check:
