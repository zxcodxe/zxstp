...
from ASTA_SPT.utils import help_pannel
from ASTA_SPT.utils.database import get_lang
from ASTA_SPT.utils.decorators.language import LanguageStart, languageCB
from ASTA_SPT.utils.inline.help import help_back_markup, private_help_panel
from config import BANNED_USERS, START_IMG_URL, SUPPORT_CHAT
from strings import get_string, helpers
from ASTA_SPT.help.buttons import BUTTONS
from ASTA_SPT.help.helper import Helper
...
async def mb_plugin_button(client, CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup([
        [    
            ...
            InlineKeyboardButton("˹ ᴘʀɪᴠᴧᴄʏ ˼", url="https://telegra.ph/Privacy-Policy--Asta-Bots-by-ALPHA-BABY-08-06")
        ]
    ])
